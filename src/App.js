...
function App() {
  ...
  return (
    <>
      ...
      <footer class="footer">made by <a href="https://surakarapushanmukhsrinivas.vercel.app" target="_blank" rel="noopener noreferrer" class="footer_link" >shanmuckh</a></footer>
    </>
  );
}
